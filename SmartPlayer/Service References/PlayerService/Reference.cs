...
namespace SmartPlayer.PlayerService {
    ...
    public partial class InsertTitleRequestBody {
        ...
        public InsertTitleRequestBody(string title, System.Nullable<int> albumId) {
            this.title = title;
    ...
    public partial class GetSongsAndQtyResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public SmartPlayer.PlayerService.Song[] GetSongsAndQtyResult;
        
        public GetSongsAndQtyResponseBody() {
        }
        
        public GetSongsAndQtyResponseBody(SmartPlayer.PlayerService.Song[] GetSongsAndQtyResult) {
    ...
    public partial class MpServiceSoapClient : System.ServiceModel.ClientBase<SmartPlayer.PlayerService.MpServiceSoap>, SmartPlayer.PlayerService.MpServiceSoap {
        ...
        public System.Threading.Tasks.Task<SmartPlayer.PlayerService.InsertTitleResponse> InsertTitleAsync(string title, System.Nullable<int> albumId) {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration) {
            if ((endpointConfiguration == EndpointConfiguration.MpServiceSoap)) {
                return new System.ServiceModel.EndpointAddress("http://192.168.43.144/MPService.asmx");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
